...
/**
 * Handles module option dropdown panel expansion and triggers smooth arrow transforms.
 * @param {string} moduleId - Target DOM container node identifier token string.
 */
function toggleModuleDropdown(moduleId) {
    const targetModule = document.getElementById(moduleId);
    const triggerBtn = document.getElementById('workspace-trigger-btn');
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    // Automatically match, map, and highlight routes
    ...
    const cachedTheme = localStorage.getItem('antinna-theme');
